(function(){
	...
	app.elements.namedItem('btn-generar1').addEventListener('click', function(){
		// Ejecutamos la funcion que generara la contraseña.
		generarPassword1();
	});
	...
	function generarPassword1(){
		...
		// Mostramos la password en el input de contraseña.
		app.elements.namedItem('input-password1').value = password;
	}
	// Funcion que nos permite copiar el texto al portapapeles.
	function copiarPassword(){
		// Selecciona el texto de un input
		app.elements.namedItem('input-password1').select();
		// Copiamos el Texto
